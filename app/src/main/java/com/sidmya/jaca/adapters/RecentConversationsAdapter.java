package com.sidmya.jaca.adapters;
...
import com.sidmya.jaca.databinding.ItemContainerRecentConversionBinding;
...
public class RecentConversationsAdapter extends RecyclerView.Adapter<RecentConversationsAdapter.ConversionViewHolder> {
    ...
    @NotNull
    @Override
    public ConversionViewHolder onCreateViewHolder(@NotNull ViewGroup parent, int viewType) {
    ...
    @Override
    public void onBindViewHolder(@NotNull RecentConversationsAdapter.ConversionViewHolder holder, int position) {
